...
#define CN_DEFAULT_RESCHEDULING             CN_RE_RULED
#define CN_DEFAULT_INITIALPRIORITIZATION    CN_IP_RANDOM
#define CNS_DEFAULT_INITIALPRIORITIZATION   CNS_IP_RANDOM
...
#define CN_DEFAULT_ALLOWANYANGLE            false
#define CNS_DEFAULT_ALLOWANYANGLE           "false"
...
#define CNS_TAG_ROOT "root"
    ...
    #define CNS_TAG_TARGETS                 "targets"
    #define CNS_TAG_AGENT                   "agent"
    #define CNS_TAG_TARGET                  "target"
 ...
 */
    ...
    #define CNS_TAG_ATTR_SX             "start.j"
    #define CNS_TAG_ATTR_SY             "start.i"
    #define CNS_TAG_ATTR_SH             "start.heading"
    #define CNS_TAG_ATTR_GX             "goal.j"
    #define CNS_TAG_ATTR_GY             "goal.i"
